...
int32_t IMU_Init( void )
{
  ...
  uint8_t IST83_InitData[IST8308_INIT_REG_LENS][2] = {
    ...
    {0x00, IST8308_CNTL4},                  /* [2] Dynamic Range ¡À500uT, Sensitivity 6.6 LSB/uT */
  ...
  ICM20948_InitData[8][0]  |= (0 << 3) | (3 << 1) | (1 << 0);       // GYRO_FCHOICE = 1,  GYRO_DLPFCFG = 0,  ¡À2000 dps
  ICM20948_InitData[9][0]  |= (0 << 3) | (1 << 1) | (1 << 0);       // ACCEL_FCHOICE = 1, ACCEL_DLPFCFG = 0, ¡À4 g
